# Library for SX127x series LoRa modules
# Author: Mauro Riva https://github.com/lemariva
# License: Apache-2.0
...
class SX127x:
    ...
    def __init__(
        ...
        #                     self.read_register(REG_MODEM_CONFIG_3) & 0xF7)
    ...
    def implicit_header_mode(self, implicit_header_mode=False):
        ...
        if self._implicit_header_mode != implicit_header_mode:
    ...
    def collect_garbage(self):
        gc.collect()
        if __DEBUG__:
            print('[Memory - free: {}  allocated: {}]'.format(gc.mem_free(),
                                                              gc.mem_alloc()))
